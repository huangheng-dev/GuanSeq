...
public record IncomingInspectionRecord(
		UUID id, String inspectionNumber, UUID sourceId, String sourceNumber,
		UUID purchaseOrderId, String purchaseOrderNumber, UUID supplierId, String supplierCode, String supplierName,
		UUID materialId, String materialCode, String materialName, String materialSpecification, String unit,
		BigDecimal inspectionQuantity, String status, String result, BigDecimal acceptedQuantity,
		BigDecimal rejectedQuantity, String inspector, String defectDescription, String conclusion,
