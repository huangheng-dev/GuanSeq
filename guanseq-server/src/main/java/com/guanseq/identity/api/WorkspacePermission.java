...
public enum WorkspacePermission {
	...
	QUALITY_NONCONFORMANCE_READ("QUALITY", "质量", "查看不合格与 CAPA", "查询当前工作区不合格来源、评审、处置、纠正措施与验证证据", Risk.SENSITIVE, "QUALITY_INSPECTOR", "QUALITY_MANAGER", "PROCUREMENT_MANAGER", "PRODUCTION_MANAGER", "ADMIN"),
	QUALITY_NONCONFORMANCE_REVIEW("QUALITY", "质量", "评审与处置不合格", "提交不合格严重度、遏制、评审、处置决定或重新打开", Risk.CRITICAL, "QUALITY_MANAGER", "ADMIN"),
	QUALITY_CORRECTIVE_ACTION_EXECUTE("QUALITY", "质量", "计划与执行纠正措施", "提交根因、纠正措施、责任到期日和完成证据", Risk.CRITICAL, "QUALITY_INSPECTOR", "QUALITY_MANAGER", "PROCUREMENT_MANAGER", "PRODUCTION_MANAGER", "ADMIN"),
	QUALITY_CORRECTIVE_ACTION_VERIFY("QUALITY", "质量", "验证纠正措施有效性", "验证处置或纠正措施是否有效并关闭或退回", Risk.CRITICAL, "QUALITY_MANAGER", "ADMIN"),
