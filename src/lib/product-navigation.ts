...
export const productAreas: ProductArea[] = [
  ...
  },
  {
    ...
    modules: [moduleItem("应收管理", "receivables"), moduleItem("销售开票与收款", "sales-settlement", [child("销售开票", "invoicing"), child("收款核销", "receipts"), child("客户对账", "reconciliation")]), moduleItem("应付管理", "payables"), moduleItem("采购发票与付款", "purchase-settlement", [child("采购发票", "invoices"), child("付款核销", "payments"), child("供应商对账", "reconciliation")]), moduleItem("成本期间", "cost-periods"), moduleItem("标准成本", "standard-costs"), moduleItem("材料成本", "material-costs"), moduleItem("制造成本", "manufacturing-costs"), moduleItem("实际成本", "actual-costs"), moduleItem("成本差异", "cost-variances"), moduleItem("订单利润", "order-profit"), moduleItem("总账税务", "general-ledger", undefined, "已规划")],
  },
  {
