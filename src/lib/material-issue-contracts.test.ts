...
describe("生产备料与领退料契约", () => {
  it("接受完整领料单、退料、流水证据和参考数据", () => {
    const issue = materialIssueRecordSchema.parse({
      ...
      events: [{ id: "64000000-0000-4000-8000-000000000001", action: "ISSUE", fromStatus: "DRAFT", toStatus: "PARTIAL", requestId: "req-1", occurredAt: "2026-08-18T01:10:00Z" }],
      stockTransactions: [{
        ...
        locationId: "72000000-0000-4000-8000-000000000001", locationCode: "A-01-03", locationName: "原料 A 区", movementId: "81000000-0000-4000-8000-000000000001", movementNumber: "MOV-20260818-000123", requestId: "req-1-I0-0", occurredAt: "2026-08-18T01:10:00Z",
      }],
    });
